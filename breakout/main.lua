...
function love.draw()
    ...
    love.graphics.draw(background.texture, 0, 0, 0, G.WINDOW.VIRTUAL.WIDTH / (background.width - 1), G.WINDOW.VIRTUAL.HEIGHT / (background.height - 1))
